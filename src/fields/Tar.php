...
namespace shuved\shukla\fields;

use shuved\shukla\Shukla;
use shuved\shukla\assetbundles\tarfield\TarFieldAsset;
...
class Tar extends Field
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'shukla/_components/fields/Tar_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(TarFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').ShuklaTar(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'shukla/_components/fields/Tar_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
